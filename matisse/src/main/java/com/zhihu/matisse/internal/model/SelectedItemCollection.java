...
public class SelectedItemCollection {
    ...
    public IncapableCause isAcceptable(Item item) {
        ...
        if (maxSelectableReached()) {
            ...
            return new IncapableCause(IncapableCause.DialogType.TOAST, "", cause);
        }
        else if (typeConflict(item)) {
            return new IncapableCause(IncapableCause.DialogType.TOAST, "", mContext.getString(R.string.error_type_conflict));
        }
